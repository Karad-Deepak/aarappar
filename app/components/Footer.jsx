...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="  text-black py-7 lg:py-10 px-6 md:px-20 lg:px-40 bg-slate-50"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="text-sm lg:text-lg">
          ...
          <ul className=" space-y-2">
            ...
            <li>
              <Link href="/reservation" className="hover:text-black transition">
                Reservations
              </Link>
            </li>
            <li>
              <Link href="/catering" className="hover:text-black transition">
                Catering
              </Link>
            </li>
            <li>
        ...
        <div className="text-sm lg:text-lg">
          ...
          <p className=" ">Primary : +49 69 21939837</p>
          <p className=" ">Secondary : +49 175 4286101</p>
      ...
      {/* Copyright Section */}
      <div className="border-t border-gray-900 mt-5 lg:mt-10 pt-5 text-center text-gray-700 text-sm">
