...
export default function PickupPage() {
  ...
  return (
    <motion.div
      className="container mx-auto px-4 py-8 bg-lightbg min-h-screen flex flex-col items-center"
      initial="hidden"
      animate="visible"
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full p-2 sm:p-3 md:p-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
              />
            </div>
            <div>
              <label
