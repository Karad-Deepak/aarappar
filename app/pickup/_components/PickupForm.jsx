...
export default function PickupForm({ pickupsEnabled }) {
  ...
  const isOrderDisabled = isMonday || !pickupsEnabled;
    ...
    <>
      ...
      >
        ...
        >
          ...
          {!pickupsEnabled && (
            <motion.div
              className="mb-4 p-4 bg-red-50 border border-red-300 rounded-lg text-center"
              variants={itemVariants}
            >
              ...
              <p className="text-red-600 text-sm mt-1">
                Please try again later or call the restaurant for assistance.
              </p>
            </motion.div>
          )}
          ...
          >
            ...
            <motion.button
              type="submit"
              disabled={isSubmitting || isOrderDisabled}
